...
async function fetchGitHubData() {
    ...
    console.log('Usando dados de fallback devido ao rate limit da API do GitHub...');
...
function useFallbackData() {
    // Dados de fallback para o perfil
    const fallbackProfile = {
        name: "Mikael Ferreira",
        bio: "Desenvolvedor Web Full Stack | JavaScript | HTML | CSS | Firebase",
        public_repos: 15,
        followers: 25,
        following: 30,
    ...
    // Dados de fallback para repositórios
    const fallbackRepos = [
        {
        ...
        },
        {
            ...
            description: "Coleção de projetos em JavaScript com diversos recursos",
        ...
        },
        {
            ...
            description: "Projetos de desenvolvimento web com tecnologias modernas",
        ...
        {
            name: "CSS-Components",
            description: "Componentes CSS reutilizáveis e responsivos",
            html_url: "https://github.com/mikaelfmts/css-components",
            language: "CSS",
            stargazers_count: 2,
            forks_count: 0
        },
        {
            ...
            description: "Projetos utilizando Firebase para backend",
            html_url: "https://github.com/mikaelfmts/firebase-projects",
            language: "JavaScript",
            stargazers_count: 6,
            forks_count: 3
        }
...
function generateFallbackSkills() {
    // Dados de fallback para as skills
