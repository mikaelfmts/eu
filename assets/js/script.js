...
window.addEventListener('load', () => {
    ...
    setTimeout(() => {
        ...
        // Verificar se estamos em uma página que possui esses elementos
        if (!reposElement && !profileElement) {
            console.log('📄 Página não possui elementos GitHub, pulando fetchGitHubData...');
            return;
        }
...
function updateGitHubProfile(profileData) {
    ...
    if (profileElement) {
        ...
        // Elemento não existe nesta página, silenciosamente ignorar
        return;
    }
}
...
// Service Worker desabilitado para evitar erros 404
/*
...
async function loadLinkedInProfile() {
    ...
    // Criar HTML simples do perfil LinkedIn - apenas card com link
    const profileHTML = `
        <div class="linkedin-card">
            <div class="linkedin-header">
                <div class="linkedin-info">
                    <h3>Mikael Ferreira</h3>
                    <div class="linkedin-title">Desenvolvedor Web Full Stack</div>
            ...
            <div class="linkedin-description">
                Conecte-se comigo no LinkedIn para acompanhar minha jornada profissional e networking.
            </div>
