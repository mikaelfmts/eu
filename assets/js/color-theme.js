...
document.addEventListener('DOMContentLoaded', function () {    // Define cores predefindas para o tema
    ...
    if (colorSelector && colorOptions) {
        colorSelector.addEventListener('click', function(e) {
            ...
            const isVisible = colorOptions.style.display === 'flex';
            ...
            // Alterna a visibilidade deste menu
            colorOptions.style.display = isVisible ? 'none' : 'flex';
            
            // Adiciona/remove classe para rastreamento
            if (isVisible) {
                colorOptions.classList.remove('dropdown-menu-open');
            } else {
                colorOptions.classList.add('dropdown-menu-open');
            }
        });
    }
    ...
    document.addEventListener('click', function(e) {
        if (colorOptions && !colorSelector.contains(e.target)) {
