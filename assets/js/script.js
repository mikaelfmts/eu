...
// Sistema de Rate Limiting Inteligente para GitHub API
const GITHUB_RATE_LIMIT = {
    max: 45, // Usar apenas 45 das 60 requisições permitidas para maior segurança
    window: 60 * 60 * 1000, // 1 hora em millisegundos
    key: 'github_rate_limit',
    cooldown: 5 * 60 * 1000 // 5 minutos de cooldown entre rajadas
};
...
// Cache Agressivo para GitHub API - Reduzir Chamadas
const GITHUB_CACHE = {
    profile: { key: 'github_profile_cache', duration: 6 * 60 * 60 * 1000 }, // 6 horas
    repos: { key: 'github_repos_cache', duration: 2 * 60 * 60 * 1000 },    // 2 horas
    userData: { key: 'github_user_cache', duration: 6 * 60 * 60 * 1000 },  // 6 horas
    languages: { key: 'github_languages_cache', duration: 4 * 60 * 60 * 1000 }, // 4 horas
    packages: { key: 'github_packages_cache', duration: 4 * 60 * 60 * 1000 }    // 4 horas
};
