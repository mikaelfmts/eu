...
<body>
    ...
    }    // FUNÇÃO DEFINITIVA: Salvar no Firebase Firestore
    async writeToHTMLFile(content, theme) {
        ...
        try {
            ...
            // Salvar no Firestore com ID fixo para sempre sobrescrever
            ...
            localStorage.setItem('curriculum-backup', JSON.stringify(curriculumData));
            
        } catch (error) {
            console.error('❌ Erro ao salvar no Firebase:', error);
            this.showNotification('❌ Erro ao salvar no Firebase: ' + error.message, 'error');
            ...
            localStorage.setItem('curriculum-backup', JSON.stringify(backupData));
            this.showNotification('💾 Salvo no localStorage como backup', 'warning');
        }
    }
