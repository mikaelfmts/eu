...
async function sendMessage() {
    ...
    try {
        ...
        // Primeiro, verificar se o chat existe, se não, criar
        const chatRef = doc(db, 'chats', currentChatId);
        const chatDoc = await getDoc(chatRef);
        
        if (!chatDoc.exists()) {
            // Criar um novo documento de chat
        ...
        // Adicionar mensagem à subcoleção mensagens do chat
        await addDoc(collection(db, 'chats', currentChatId, 'mensagens'), messageData);
