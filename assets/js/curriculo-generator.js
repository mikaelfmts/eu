...
<body>
    ...
    async writeToHTMLFile(content, theme) {
        ...
        // Mostrar o conteúdo completo que deve ser copiado
        this.showDirectHTMLReplacement(content, theme);
    }

    // Mostrar exatamente o que deve ser substituído no arquivo
    showDirectHTMLReplacement(content, theme) {
        // Gerar o conteúdo final que deve ficar entre os comentários
        const finalContent = `            <!-- GENERATED_CURRICULUM_START -->
            ${content}
            <!-- GENERATED_CURRICULUM_END -->`;
        
        // Criar modal com instruções SUPER CLARAS
        ...
        modalContent.innerHTML = `
            <h2 style="color: #EF4444; margin-bottom: 20px; text-align: center;">
                🔥 SUBSTITUIÇÃO DIRETA NO ARQUIVO curriculum.html
            </h2>
            
            <div style="background: #FEF2F2; padding: 20px; border: 2px solid #EF4444; border-radius: 10px; margin-bottom: 20px;">
                <h3 style="color: #DC2626; margin: 0 0 15px 0;">📋 INSTRUÇÕES OBRIGATÓRIAS:</h3>
                <ol style="color: #7F1D1D; font-weight: bold; line-height: 1.8;">
                    <li>Abra o arquivo <code style="background: #FEE2E2; padding: 2px 6px; border-radius: 4px;">pages/curriculum.html</code></li>
                    <li>Procure por esta linha: <code style="background: #FEE2E2; padding: 2px 6px; border-radius: 4px;">&lt;!-- GENERATED_CURRICULUM_START --&gt;</code></li>
                    <li>SUBSTITUA tudo entre os comentários START e END pelo código abaixo</li>
                    <li>Salve o arquivo (Ctrl+S)</li>
                    <li>PRONTO! O currículo ficará PERMANENTE no arquivo!</li>
                </ol>
            </div>
            ...
            <div style="margin-bottom: 20px; text-align: center;">
                <button id="copyContentBtn" style="
                    ...
                    font-size: 18px; font-weight: bold; margin-right: 15px;
                ">📋 COPIAR CONTEÚDO</button>
                
                <button id="openFileBtn" style="
            ...
            <div style="background: #F9FAFB; border: 2px solid #D1D5DB; border-radius: 8px; padding: 15px;">
                <h4 style="color: #374151; margin: 0 0 10px 0;">🎯 CÓDIGO PARA SUBSTITUIR:</h4>
                <textarea readonly id="contentToCopy" style="
                    width: 100%; height: 300px; font-family: 'Courier New', monospace;
                    border: 1px solid #D1D5DB; border-radius: 6px; padding: 15px;
                    font-size: 12px; line-height: 1.4; resize: vertical;
                    background: #FFFFFF;
                ">${finalContent}</textarea>
            </div>
            
            <div style="background: #ECFDF5; border: 2px solid #10B981; border-radius: 8px; padding: 15px; margin-top: 20px;">
                <h4 style="color: #065F46; margin: 0 0 10px 0;">✅ LOCALIZAÇÃO EXATA NO ARQUIVO:</h4>
                <p style="color: #047857; margin: 0; font-family: monospace; font-size: 14px;">
                    Procure por: <strong>&lt;!-- GENERATED_CURRICULUM_START --&gt;</strong><br>
                    Até: <strong>&lt;!-- GENERATED_CURRICULUM_END --&gt;</strong><br>
                    Linha aproximada: <strong>535-537</strong>
                </p>
            </div>
        `;
        ...
        document.getElementById('copyContentBtn').onclick = () => {
            ...
            this.showNotification('✅ Conteúdo copiado! Agora cole no arquivo curriculum.html', 'success');
        };
        
        document.getElementById('openFileBtn').onclick = () => {
            // Tentar abrir o arquivo diretamente (funciona em alguns ambientes)
            const filePath = 'pages/curriculum.html';
            window.open(filePath, '_blank');
            this.showNotification('📂 Tentando abrir o arquivo curriculum.html', 'info');
        };
        ...
        // Auto-selecionar o conteúdo ao abrir
        setTimeout(() => {
            document.getElementById('contentToCopy').focus();
        }, 500);
    }
