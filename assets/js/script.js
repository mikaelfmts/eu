...
function updateProfilePicture(avatarUrl) {
    ...
    // Melhorar estilo do container da foto de perfil - mínimo pois já temos estilos no CSS
    const profileContainers = document.querySelectorAll('.foto-perfil');
    profileContainers.forEach(container => {
        container.style.overflow = 'hidden';
        container.style.transition = 'all 0.3s ease';
        
        // Não precisamos adicionar listeners de hover, já temos no CSS
    });
        ...
        setTimeout(() => {
            ...
            imgElement.onload = function() {
                ...
                if (parentElement) {
                    ...
                    setTimeout(() => {
                        parentElement.style.boxShadow = '0 2px 6px rgba(0, 0, 0, 0.5)';
