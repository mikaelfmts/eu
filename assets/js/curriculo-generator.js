...
<body>
    <div class="container">
        ...
        try {
            ...
            localStorage.setItem('curriculum-updated', Date.now().toString());
            
            // Tentar comunicação direta com páginas abertas
            try {
                ...
                console.log('BroadcastChannel não suportado:', error);
            }
            
            console.log('Currículo atualizado com sucesso no localStorage');
            
            // Mostrar notificação de sucesso
            this.showNotification('Currículo salvo com sucesso! A página curriculum.html será atualizada automaticamente.', 'success');
            
        } catch (error) {
            console.error('Erro ao atualizar curriculum.html:', error);
            this.showNotification('Erro ao atualizar o currículo. Tente novamente.', 'error');
        }
    }
