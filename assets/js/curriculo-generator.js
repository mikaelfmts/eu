...
function applyCustomColorsToPreview(container, colors) {
    ...
    style.textContent = `
        #curriculum-preview .curriculum-name,
        #curriculum-preview .curriculum-title {
        ...
        #curriculum-preview .main-text,
        #curriculum-preview p,
        #curriculum-preview .description,
        #curriculum-preview .content-text {
            color: ${colors.mainText} !important;
        }
        
        #curriculum-preview .highlight,
        #curriculum-preview .company-name,
        #curriculum-preview .project-name,
        #curriculum-preview .position {
            color: ${colors.highlight} !important;
        }
        
        #curriculum-preview .contact-link,
        #curriculum-preview a,
        #curriculum-preview .link {
            color: ${colors.link} !important;
        }
        
        #curriculum-preview .skill-tag,
        #curriculum-preview .skill-item,
        #curriculum-preview .technology {
            color: ${colors.skills} !important;
            border-color: ${colors.skills} !important;
        }
        
        #curriculum-preview .skill-progress {
            background-color: ${colors.skills} !important;
        }
    `;
