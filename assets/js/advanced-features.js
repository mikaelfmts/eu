...
class LanguageTranslator {
    constructor() {
        ...
        this.translations = {
            ...
            'en-US': {
                ...
                'Front-end Development': 'Front-end Development',                'Web Development': 'Web Development',
                'React': 'React',
                'Node.js': 'Node.js',
            ...
            'es-ES': {
                ...
                'Certificates in progress': 'Certificados en Progreso',
                  // Cabeçalho
                'Desenvolvedor Web Full Stack': 'Desarrollador Web Full Stack',
                ...
                'Front-end Development': 'Desarrollo Front-end',                'Web Development': 'Desarrollo Web',
                'React': 'React',
                'Node.js': 'Node.js',
    ...
    createLanguageSwitcher() {
        ...
        languageSwitcher.innerHTML = Object.entries(languageOptions)
            ...
            .join('');
          // Adicionar ao DOM dentro da div top-controls (após o seletor de cores)
        const topControls = document.querySelector('.top-controls');
        const colorSelector = document.getElementById('color-selector');
        const notificationBtn = document.getElementById('notification-btn');
        
        if (topControls && colorSelector) {
            // Inserir após o seletor de cores
            topControls.insertBefore(languageSwitcher, colorSelector.nextSibling);
        } else if (topControls && notificationBtn) {
            // Ou antes do botão de notificação, se existir
            topControls.insertBefore(languageSwitcher, notificationBtn);
        } else if (topControls) {
            // Ou apenas dentro da área de controles
            topControls.appendChild(languageSwitcher);
        } else {
